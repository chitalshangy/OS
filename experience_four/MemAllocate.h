...
public:
	...
	void CMemAllocate::AllocateMem_BestAdapt(CMemAllocate::JCBInfo& job);//最佳适配算法

	void CMemAllocate::AllocateMem_NextAdapt(CMemAllocate::JCBInfo& job);//临近适配算法

	void DelAJob(int JobIndex);//删除一个进程
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
